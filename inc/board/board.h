...
/* OLED显示屏接口 SSD1357驱动（I2C） */
#define BOARD_LCD_RST_PORT  GPIOA
#define BOARD_LCD_RST_PIN   GPIO_PIN_6
#define BOARD_LCD_I2C_SCL_PORT GPIOC
#define BOARD_LCD_I2C_SCL_PIN  GPIO_PIN_4
#define BOARD_LCD_I2C_SDA_PORT GPIOC
#define BOARD_LCD_I2C_SDA_PIN  GPIO_PIN_5
