...
/* USART2 -> 电子罗盘 (PA2/PA3) */
#define COMPASS_TX_PORT GPIOA
#define COMPASS_TX_PIN  GPIO_PIN_2
#define COMPASS_RX_PORT GPIOA
#define COMPASS_RX_PIN  GPIO_PIN_3

/* UART6 -> 测距机 (重映射 PB0/PB1) */
#define RANGER_TX_PORT  GPIOB
#define RANGER_TX_PIN   GPIO_PIN_0
#define RANGER_RX_PORT  GPIOB
#define RANGER_RX_PIN   GPIO_PIN_1
...
static uart_dev_t uart_devs[BSP_UART_NUM] = {
    [BSP_UART_GNSS] =
        {
            .usart   = USART1,
            .tx_port = GNSS_TX_PORT,
            .tx_pin  = GNSS_TX_PIN,
            .rx_port = GNSS_RX_PORT,
            .rx_pin  = GNSS_RX_PIN,
            .irqn    = USART1_IRQn,
        },
    [BSP_UART_COMPASS] =
        {
            ...
            .tx_pin  = COMPASS_TX_PIN,
            .rx_port = COMPASS_RX_PORT,
            .rx_pin  = COMPASS_RX_PIN,
            .irqn    = USART2_IRQn,
        },
    [BSP_UART_RANGER] =
        {
            .usart   = UART6,
            .tx_port = RANGER_TX_PORT,
            .tx_pin  = RANGER_TX_PIN,
            .rx_port = RANGER_RX_PORT,
            .rx_pin  = RANGER_RX_PIN,
            .irqn    = UART6_IRQn,
        },
};

static void usart_rcc_enable(bsp_uart_t port)
{
    switch (port)
    {
    case BSP_UART_GNSS:
...
static void uart_rx_isr(bsp_uart_t port)
{
    uart_dev_t* dev    = &uart_devs[port];
