/**
 * @file app_attitude.c
 * @brief 姿态解算实现（接入 MCG505 型全国产三维电子罗盘）
 */
...
{
    const mcg505_data_t* compass = mcg505_get_data();
    int32_t              h;
    int32_t              p;
    ...
    /* 俯仰：MCG505 输出 ±90.00°，叠加 PIt 补偿，截断到 ±90° */
    ...
    /* 航向：MCG505 输出 0.00°~359.99°，叠加 HIt + HEr 补偿，归一化到 0.00°~359.99° */
